...
const socialLinks = [
 { 
  ...
  color: 'bg-[#3b5998]', 
  text: 'Like Us on', 
  link: 'https://www.facebook.com/saibabawomenshospital' 
 },
 { 
  name: 'Instagram', 
  icon: <FaInstagram />, 
  ...
  text: 'Follow Us on', 
  link: 'https://www.instagram.com/sbh_womens_hospital' 
 },
 { 
  name: 'YouTube', 
  icon: <FaYoutube />, 
  color: 'bg-[#ff0000]', 
  text: 'Subscribe on', 
  link: 'https://www.youtube.com/@saibabawomenshospital7871' 
 },
 { 
  name: 'Whatsapp', 
  icon: <FaWhatsapp />, 
...
const SocialStickyWomen: React.FC = () => {
  ...
  <div className="fixed top-1/2 -translate-y-1/2 right-0 z-[999] flex flex-col items-end">
   ...
   >
    <p className="text-gray-600">
     Updating your settings will take effect immediately across all devices.
    </p>
   </Modal>
  </div>
...
export default SocialStickyWomen;