...
const doctors: Doctor[] = [
  { id: 1, name: "Dr. Ashish Mahobia", specialty: "MBBS, MS (Mumbai), FNB (Retina), MRCS (UK), EVRT (Germany)", image: "assets/doctor/dr-one.png", available: true },
  { id: 2, name: "Dr. Shamali Kohade", specialty: "MBBS, MS (RIO, BHOPAL), Fellow in Glaucoma (LVPEI, Hyderabad)",  image: "assets/doctor/dr-three.png", available: true },
  { id: 3, name: "Dr. Ashik R.", specialty: "MD (AIIMS) Phaco & Oculoplasty Surgeon", image: "assets/doctor/dr-four.png", available: true },
  { id: 4, name: "Dr. Madhu Lata Pardeshi", specialty: "MBBS, MS, Ex Glaucoma Fellow (Sankara Eye Hospital, Banglore)",  image: "assets/doctor/dr-five.png", available: true },
  { id: 5, name: "Dr. Stuti Tiwari", specialty: "MBBS, MS (Ophthalmology) Fellowship in Cornea & Referactive Surgery", image: "assets/doctor/dr-six.png", available: true },
];
